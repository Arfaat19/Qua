...
import time,random,vrplib as cvrplib
...
def get_token():
    return 'DEV-bcb1965c27198de97c9371470bc01c46a5d26ba6'

print("Running Annealing process")
startime=time.time()
sampler=LeapHybridCQMSampler(token=get_token())
sampleset = sampler.sample_cqm(cqm,time_limit=300,label='CVRP')
